...
const UploadDocumentModal = ({ isOpen, onClose, onUpload }) => {
  ...
  const handleFileChange = (e) => {
    ...
    // Simulate upload progress for files that are under 50MB
    setUploading(true);
    newFiles.forEach((file, index) => {
      if (file.error) return; // Skip files that exceed size limit
                ...
                <div className="file-header">
                  ...
                  <div className="file-actions">
                    ...
                    {file.error && (
                      ...
                      >
                        <IoMdRefresh size={16} className="file-success"/>
                      </button>
                    )}
                  </div>
                </div>
