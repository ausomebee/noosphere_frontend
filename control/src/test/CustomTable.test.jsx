 ...
 *
 * Rendering CustomTable exercises TableHeader, TableBody and Pagination
 * together, which is how the app uses them. Date-keyed filters take a range
 * rather than a value, and rows are addressed by index for selection but by id
 * for the payload the parent receives -- both are pinned down below.
 */
...
describe('rendering', () => {
  ...
  it('shows a loader instead of the body while loading', () => {
...
describe('pagination', () => {
  ...
  it('hides its own pagination when the server is paging', () => {
    renderTable({ data: many, itemsPerPage: 5, hidePagination: true });
...
describe('export and print', () => {
  ...
  it('exports the filtered rows as CSV', () => {
    ...
    expect(exportTableData).toHaveBeenCalled();
