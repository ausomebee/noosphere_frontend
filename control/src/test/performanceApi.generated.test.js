...
import api from '../api/performanceApi.js';

/**
 * Every wrapper in performanceApi.js follows one shape: build an authenticated client,
...
const WRAPPERS = [
  ['GetGeneralMetrics', 'get', {  }, 'Failed to fetch general performance metrics', 'body'],
  ['GetGeneralTimeseries', 'get', {  }, 'Failed to fetch general performance timeseries', 'body'],
  ['GetApiErrorRate', 'get', {  }, 'Failed to fetch API error rate', 'body'],
  ['GetResourceMetrics', 'get', {  }, 'Failed to fetch resource metrics', 'body'],
  ['GetResourceTimeseries', 'get', {  }, 'Failed to fetch resource timeseries', 'body'],
];
