...
import api from '../api/roleApis.js';

/**
 * Every wrapper in roleApis.js follows one shape: build an authenticated client,
...
const WRAPPERS = [
  ['CreateRole', 'post', { name: "name", dataAccessLevel: "dataAccessLevel", createdByAdminId: "createdByAdminId", moduleAccesses: "moduleAccesses" }, 'Role creation failed', 'body'],
  ['UpdateRole', 'patch', { id: "id", name: "name", dataAccessLevel: "dataAccessLevel", moduleAccesses: "moduleAccesses" }, 'Role update failed', 'body'],
  ['GetRolesByModule', 'get', {  }, 'Failed to fetch roles', 'body'],
  ['GetRoleById', 'get', { id: "id" }, 'Failed to fetch role', 'body'],
  ['DeactivateRole', 'put', { id: "id" }, 'Role deactivation failed', 'body'],
  ['ActivateRole', 'put', { id: "id" }, 'Role activation failed', 'body'],
];
