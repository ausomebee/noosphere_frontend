...
import api from '../api/staffApis.js';

/**
 * Every wrapper in staffApis.js follows one shape: build an authenticated client,
...
const WRAPPERS = [
  ['GetAllAdmins', 'get', {  }, 'Failed to fetch staff', 'body'],
  ['GetAdmin', 'get', { id: "id" }, 'Failed to fetch admin', 'body'],
  ['CreateAdmin', 'post', { firstName: "firstName", lastName: "lastName", email: "email", phoneNumber: "phoneNumber", roleId: "roleId", departmentId: "departmentId" }, 'Failed to create staff', 'body'],
  ['UpdateAdmin', 'put', { id: "id", firstName: "firstName", lastName: "lastName", email: "email", phoneNumber: "phoneNumber", roleId: "roleId", departmentId: "departmentId" }, 'Failed to update staff', 'body'],
  ['ToggleAdminActive', 'put', { id: "id", active: "active" }, 'Failed to update staff status', 'body'],
  ['GetAllRoles', 'get', {  }, 'Failed to fetch roles', 'body'],
];
