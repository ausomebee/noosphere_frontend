    ...
    <div className="auth-background">
      ...
      <div className="auth-form-container">
        ...
        <p className="subtitle">
          To protect your users’ data, two-factor authentication (2FA) is
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="form-group settings-group">
            <div className="settings-item">
              ...
              <SwitchInput {...register("enable2FA")} inputPosition="after" />
            </div>
            ...
            <div className="settings-item">
              <label className="settings-label">
                ...
                <p className="settings-note">
                  You can change this later in <strong>settings</strong>
                </p>
              </label>
            </div>
            <div>
                    ...
                    label={
                      <>
                        ...
                        <span className="radio-description">
                          Users will scan a QR code to set up this method, and
                          use a generated time-based code for secure login.
                        </span>
                      </>
                    }
                  ...
                  <RadioInput
                    label={
                      <>
                        ...
                        <span className="radio-description">
                          Users will select a security question and provide an
                          answer that only they can know.
                        </span>
                      </>
                    }
                    name="default2FAMethod"
...
export default SuperAdmin2FASettings;
