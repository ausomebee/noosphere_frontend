...
export const PERMISSIONS_CONFIG = {
    ...
    subcategories: [
      ...
      },
      {
        ...
        permissions: [
          ...
          { key: "view_client_document", label: "View document" },
          { key: "delete_client_document", label: "Delete document" },
          ...
          { key: "edit_client_program", label: "Edit program" },
          { key: "delete_client_program", label: "Delete program" },
    ...
    subcategories: [
      {
        ...
        permissions: [
          ...
          { key: "view_org_document", label: "View document" },
          { key: "delete_org_document", label: "Delete document" },
        ],
      },
      {
        ...
        permissions: [
          ...
          // Moved here from Billing & Payments → Settings (features now live in
          // My Organization → Practice Settings).
  ...
  BILLINGS_PAYMENTS: {
    ...
    subcategories: [
      ...
      // Settings (Service Codes, Rounding Rules, Payers & Insurance) moved to
      // My Organization → Practice Settings.
    ],
  },
    ...
    subcategories: [
      {
        ...
        permissions: [
          ...
          { key: "edit_library_program", label: "Edit program" },
          { key: "delete_library_program", label: "Delete program" },
