...
import api from '../api/DashboardApis.js';

/**
 * Every wrapper in DashboardApis.js follows one shape: build an authenticated client,
...
const WRAPPERS = [
  ['GetDashboardIntakeByTenantId', 'get', { tenantId: "tenantId" }, 'Get dashboard intake by tenant id failed', 'body'],
  ['GetAllTenantClientAuthorization', 'get', { tenantId: "tenantId", status: "status" }, 'Get client Authorization by tenant id and status failed', 'body'],
  ['GetTenantClientAuthorizationMetrics', 'get', { tenantId: "tenantId" }, 'Get client Authorization Metric by tenant id failed', 'body'],
  ['GetTenantSessionMetrics', 'get', { tenantId: "tenantId", status: "status", period: "period" }, 'Get Session Metric by tenant id failed', 'body'],
  ['GetTenantSessionOverviewMetrics', 'get', { tenantId: "tenantId" }, 'Get Session Overview Metric by tenant id failed', 'body'],
  ['GetTenantAvailabilityCount', 'get', { tenantId: "tenantId" }, 'Get Tenant Availability Count by tenant id failed', 'body'],
  ['GetTenantCaseloadCount', 'get', { tenantId: "tenantId" }, 'Get Tenant Caseload Count by tenant id failed', 'body'],
];
