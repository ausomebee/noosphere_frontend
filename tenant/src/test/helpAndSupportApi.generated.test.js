...
import api from '../api/helpAndSupportApi.js';

/**
 * Every wrapper in helpAndSupportApi.js follows one shape: build an authenticated client,
...
const WRAPPERS = [
  ['GetHelpAndSupportTicketsByTenantId', 'get', { tenantId: "tenantId" }, 'Get Help and Support tickets failed', 'message'],
  ['GetHelpAndSupportTicketsOverviewByTenantId', 'get', { tenantId: "tenantId" }, 'Get Help and Support tickets overview failed', 'message'],
  ['GetSingleTicketById', 'get', { ticketId: "ticketId" }, 'Get single ticket failed', 'message'],
  ['ChangeSupportRequestStatus', 'patch', { id: "id", status: "status", updatedBy: "updatedBy" }, 'Change support request status failed', 'body'],
];
