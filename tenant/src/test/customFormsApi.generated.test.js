...
import api from '../api/customFormsApi.js';

/**
 * Every wrapper in customFormsApi.js follows one shape: build an authenticated client,
...
const WRAPPERS = [
  ['CreateCustomForm', 'post', { tenantId: "tenantId", name: "name", isDraft: "isDraft", isTemplate: "isTemplate", formFields: "formFields" }, 'Create forms failed', 'message'],
  ['UpdateCustomForm', 'put', { id: "id", tenantId: "tenantId", name: "name", isDraft: "isDraft", isTemplate: "isTemplate", formFields: "formFields" }, 'update forms failed', 'message'],
  ['GetFormsByTenantId', 'get', { tenantId: "tenantId" }, 'Get forms by tenant id failed', 'message'],
  ['GetDraftsByTenantId', 'get', { tenantId: "tenantId" }, 'Get forms drafts by tenant id failed', 'message'],
  ['GetTemplatesByTenantId', 'get', { tenantId: "tenantId" }, 'Get forms templates by tenant id failed', 'message'],
  ['GetFormsByFormId', 'get', { formId: "formId" }, 'Get forms by form id failed', 'message'],
  ['DuplicateFormByFormId', 'post', { formId: "formId" }, 'Duplicate form by form id failed', 'message'],
  ['DeleteFormsByFormId', 'patch', { formId: "formId", active: "active" }, 'Delete a form by form id failed', 'message'],
  ['GetFormResponsesByFormId', 'get', { formId: "formId" }, 'Get form responses failed', 'message'],
];
