...
describe("homeApis", () => {
  ...
  describe("GetClientUpcomingAppointments", () => {
    it("calls correct endpoint", async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith(expect.stringContaining("/appointments/client/upcoming/c1"));
    });
  });
  ...
  describe("GetClientCompletedAppointments", () => {
    it("calls correct endpoint", async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith(expect.stringContaining("/sessions/client/c1"));
    });
  });
  ...
  describe("GetClientRescheduledAppointments", () => {
    it("calls correct endpoint", async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith(expect.stringContaining("/appointments/client/rescheduled/c1"));
    });
  });
